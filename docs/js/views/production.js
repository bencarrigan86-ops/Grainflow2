...
import { productionByCommodity, fieldTons, estimateFieldTons, movementTonsFromField, fieldUrea, fieldSeed, groupFieldsByCommodity } from '../derived.js?v=36';
import { num, tons, ha, esc } from '../fmt.js?v=36';
