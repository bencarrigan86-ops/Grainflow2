...
import { renderPosition } from './views/position.js?v=40';
import { renderProduction } from './views/production.js?v=40';
import { renderReports } from './views/reports.js?v=40';
import { renderSales } from './views/sales.js?v=40';
import { renderMovements } from './views/movements.js?v=40';
import { renderStorage } from './views/storage.js?v=40';
import { renderSettings } from './views/settings.js?v=40';
