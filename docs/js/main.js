import { renderPosition } from './views/position.js?v=21';
import { renderProduction } from './views/production.js?v=21';
import { renderFertiliser } from './views/fertiliser.js?v=21';
import { renderSeed } from './views/seed.js?v=21';
import { renderSales } from './views/sales.js?v=21';
import { renderMovements } from './views/movements.js?v=21';
import { renderStorage } from './views/storage.js?v=21';
import { renderCalculator } from './views/calculator.js?v=21';
...
const TABS = [
  ...
  { id: 'calculator', label: 'Calc', icon: '\u{1F9EE}', render: renderCalculator },
