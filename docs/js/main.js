...
import { renderPosition } from './views/position.js?v=44';
import { renderProduction } from './views/production.js?v=44';
import { renderReports } from './views/reports.js?v=44';
import { renderSales } from './views/sales.js?v=44';
import { renderMovements } from './views/movements.js?v=44';
import { renderStorage } from './views/storage.js?v=44';
