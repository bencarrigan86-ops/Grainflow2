...
import { renderPosition } from './views/position.js?v=34';
import { renderProduction } from './views/production.js?v=34';
import { renderReports } from './views/reports.js?v=34';
import { renderSales } from './views/sales.js?v=34';
import { renderMovements } from './views/movements.js?v=34';
import { renderStorage } from './views/storage.js?v=34';
