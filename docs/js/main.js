...
import { renderPosition } from './views/position.js?v=42';
import { renderProduction } from './views/production.js?v=42';
import { renderReports } from './views/reports.js?v=42';
import { renderSales } from './views/sales.js?v=42';
import { renderMovements } from './views/movements.js?v=42';
import { renderStorage } from './views/storage.js?v=42';
