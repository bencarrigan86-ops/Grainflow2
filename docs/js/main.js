...
import { renderPosition } from './views/position.js?v=33';
import { renderProduction } from './views/production.js?v=33';
import { renderReports } from './views/reports.js?v=33';
import { renderSales } from './views/sales.js?v=33';
import { renderMovements } from './views/movements.js?v=33';
import { renderStorage } from './views/storage.js?v=33';
