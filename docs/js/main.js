...
import { renderPosition } from './views/position.js?v=30';
import { renderProduction } from './views/production.js?v=30';
import { renderReports } from './views/reports.js?v=30';
import { renderSales } from './views/sales.js?v=30';
import { renderMovements } from './views/movements.js?v=30';
import { renderStorage } from './views/storage.js?v=30';
