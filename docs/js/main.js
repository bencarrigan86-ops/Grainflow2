...
import { renderPosition } from './views/position.js?v=36';
import { renderProduction } from './views/production.js?v=36';
import { renderReports } from './views/reports.js?v=36';
import { renderSales } from './views/sales.js?v=36';
import { renderMovements } from './views/movements.js?v=36';
import { renderStorage } from './views/storage.js?v=36';
