...
import { renderPosition } from './views/position.js?v=45';
import { renderProduction } from './views/production.js?v=45';
import { renderReports } from './views/reports.js?v=45';
import { renderSales } from './views/sales.js?v=45';
import { renderMovements } from './views/movements.js?v=45';
import { renderStorage } from './views/storage.js?v=45';
import { renderSettings } from './views/settings.js?v=45';
