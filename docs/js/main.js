...
import { renderPosition } from './views/position.js?v=35';
import { renderProduction } from './views/production.js?v=35';
import { renderReports } from './views/reports.js?v=35';
import { renderSales } from './views/sales.js?v=35';
import { renderMovements } from './views/movements.js?v=35';
import { renderStorage } from './views/storage.js?v=35';
