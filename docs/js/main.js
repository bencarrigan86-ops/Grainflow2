...
import { renderPosition } from './views/position.js?v=43';
import { renderProduction } from './views/production.js?v=43';
import { renderReports } from './views/reports.js?v=43';
import { renderSales } from './views/sales.js?v=43';
import { renderMovements } from './views/movements.js?v=43';
import { renderStorage } from './views/storage.js?v=43';
