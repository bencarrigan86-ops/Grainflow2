import { renderPosition } from './views/position.js?v=14';
import { renderProduction } from './views/production.js?v=14';
import { renderSales } from './views/sales.js?v=14';
import { renderMovements } from './views/movements.js?v=14';
import { renderStorage } from './views/storage.js?v=14';
import { renderSettings } from './views/settings.js?v=14';
