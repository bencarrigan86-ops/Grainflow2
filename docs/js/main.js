import { renderPosition } from './views/position.js?v=12';
import { renderProduction } from './views/production.js?v=12';
import { renderSales } from './views/sales.js?v=12';
import { renderMovements } from './views/movements.js?v=12';
import { renderStorage } from './views/storage.js?v=12';
