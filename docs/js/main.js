import { renderPosition } from './views/position.js?v=11';
import { renderProduction } from './views/production.js?v=11';
import { renderSales } from './views/sales.js?v=11';
import { renderMovements } from './views/movements.js?v=11';
import { renderStorage } from './views/storage.js?v=11';
