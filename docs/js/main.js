import { renderPosition } from './views/position.js?v=13';
import { renderProduction } from './views/production.js?v=13';
import { renderSales } from './views/sales.js?v=13';
import { renderMovements } from './views/movements.js?v=13';
import { renderStorage } from './views/storage.js?v=13';
