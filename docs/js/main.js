...
import { renderPosition } from './views/position.js?v=27';
import { renderProduction } from './views/production.js?v=27';
import { renderFertiliser } from './views/fertiliser.js?v=27';
import { renderSeed } from './views/seed.js?v=27';
import { renderSales } from './views/sales.js?v=27';
import { renderMovements } from './views/movements.js?v=27';
import { renderStorage } from './views/storage.js?v=27';
import { renderSettings } from './views/settings.js?v=27';
