...
import { renderPosition } from './views/position.js?v=38';
import { renderProduction } from './views/production.js?v=38';
import { renderReports } from './views/reports.js?v=38';
import { renderSales } from './views/sales.js?v=38';
import { renderMovements } from './views/movements.js?v=38';
import { renderStorage } from './views/storage.js?v=38';
import { renderSettings } from './views/settings.js?v=38';
