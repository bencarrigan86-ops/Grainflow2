...
import { renderPosition } from './views/position.js?v=37';
import { renderProduction } from './views/production.js?v=37';
import { renderReports } from './views/reports.js?v=37';
import { renderSales } from './views/sales.js?v=37';
import { renderMovements } from './views/movements.js?v=37';
import { renderStorage } from './views/storage.js?v=37';
