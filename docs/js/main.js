...
import { renderPosition } from './views/position.js?v=41';
import { renderProduction } from './views/production.js?v=41';
import { renderReports } from './views/reports.js?v=41';
import { renderSales } from './views/sales.js?v=41';
import { renderMovements } from './views/movements.js?v=41';
import { renderStorage } from './views/storage.js?v=41';
