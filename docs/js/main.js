...
import { renderPosition } from './views/position.js?v=48';
import { renderProduction } from './views/production.js?v=48';
import { renderReports } from './views/reports.js?v=48';
import { renderSales } from './views/sales.js?v=48';
import { renderMovements } from './views/movements.js?v=48';
import { renderStorage } from './views/storage.js?v=48';
import { renderSettings } from './views/settings.js?v=48';
